...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-materialize-css/node_modules/materialize-css/jade/search.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-materialize-css/node_modules/materialize-css/jade/search.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-materialize-css/node_modules/materialize-css/jade/</a> &#187; search.js</div>
</div>
<div class="body">
...
359
360
361</td><td class="line-coverage"><span class="cline-any cline-yes">2</span>
...
<span class="cstat-no" title="statement not covered" >    window.index = lunr(<span class="fstat-no" title="function not covered" >function () {</span></span>
...
<span class="cstat-no" title="statement not covered" >      this.ref('href');</span>
    });
<span class="cstat-no" title="statement not covered" >    window.index.pipeline.reset();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    window.index.add({</span>
...
&nbsp;
    // icon click
<span class="cstat-no" title="statement not covered" >    $('ul#nav-mobile li.search .search-wrapper i.material-icons').click(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >      if ($('.search-results .focused').length) {</span>
<span class="cstat-no" title="statement not covered" >        $('.search-results .focused').first()[0].click();</span>
      } else <span class="cstat-no" title="statement not covered" >if ($('.search-results').children().length) {</span>
<span class="cstat-no" title="statement not covered" >        $('.search-results').children().first()[0].click();</span>
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    var renderResults = <span class="fstat-no" title="function not covered" >function(results) {</span></span>
<span class="cstat-no" title="statement not covered" >      var resultsContainer = $('.search-results');</span>
<span class="cstat-no" title="statement not covered" >      resultsContainer.empty();</span>
...
<span class="cstat-no" title="statement not covered" >        var resultDiv = $('&lt;a href=' + result[1] + '&gt;' + result[0] + '&lt;/a&gt;');</span>
<span class="cstat-no" title="statement not covered" >        resultsContainer.append(resultDiv);</span>
      });
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    var debounce = <span class="fstat-no" title="function not covered" >function (fn) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    $('input#search').focus(<span class="fstat-no" title="function not covered" >function() {</span> <span class="cstat-no" title="statement not covered" >$(this).parent().addClass('focused'); </span>});</span>
<span class="cstat-no" title="statement not covered" >    $('input#search').blur(<span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >      if (!$(this).val()) {</span>
<span class="cstat-no" title="statement not covered" >        $(this).parent().removeClass('focused');</span>
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    $('input#search').bind('keyup', debounce(<span class="fstat-no" title="function not covered" >function (e) {</span></span>
<span class="cstat-no" title="statement not covered" >      if ($(this).val() &lt; 2) {</span>
<span class="cstat-no" title="statement not covered" >        renderResults([]);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (e.which === 38 || e.which === 40 || e.keyCode === 13) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var query = $(this).val();</span>
<span class="cstat-no" title="statement not covered" >      var results = window.index.search(query).slice(0, 6).map(<span class="fstat-no" title="function not covered" >function (result) {</span></span>
<span class="cstat-no" title="statement not covered" >        var href = result.ref.split('http://materializecss.com/')[1];</span>
<span class="cstat-no" title="statement not covered" >        return [href.charAt(0).toUpperCase() + href.slice(1), result.ref];</span>
      });
<span class="cstat-no" title="statement not covered" >      renderResults(results);</span>
    }));
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >    $('input#search').bind('keydown', debounce(<span class="fstat-no" title="function not covered" >function (e) {</span></span>
      // Escape.
...
<span class="cstat-no" title="statement not covered" >        renderResults([]);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      } else <span class="cstat-no" title="statement not covered" >if (e.keyCode === 13) {</span>
        // enter
<span class="cstat-no" title="statement not covered" >        if ($('.search-results .focused').length) {</span>
<span class="cstat-no" title="statement not covered" >          $('.search-results .focused').first()[0].click();</span>
        } else <span class="cstat-no" title="statement not covered" >if ($('.search-results').children().length) {</span>
...
<span class="cstat-no" title="statement not covered" >      switch(e.which) {</span>
        case 38: // up
<span class="cstat-no" title="statement not covered" >          if ($('.search-results .focused').length) {</span>
<span class="cstat-no" title="statement not covered" >            focused = $('.search-results .focused');</span>
<span class="cstat-no" title="statement not covered" >            focused.removeClass('focused');</span>
<span class="cstat-no" title="statement not covered" >            focused.prev().addClass('focused');</span>
          }
<span class="cstat-no" title="statement not covered" >          break;</span>
&nbsp;
        case 40: // down
<span class="cstat-no" title="statement not covered" >          if (!$('.search-results .focused').length) {</span>
<span class="cstat-no" title="statement not covered" >            focused = $('.search-results').children().first();</span>
<span class="cstat-no" title="statement not covered" >            focused.addClass('focused');</span>
          } else {
<span class="cstat-no" title="statement not covered" >            focused = $('.search-results .focused');</span>
<span class="cstat-no" title="statement not covered" >            if (focused.next().length) {</span>
<span class="cstat-no" title="statement not covered" >              focused.removeClass('focused');</span>
<span class="cstat-no" title="statement not covered" >              focused.next().addClass('focused');</span>
            }
          }
<span class="cstat-no" title="statement not covered" >          break;</span>
&nbsp;
        default: <span class="cstat-no" title="statement not covered" >return; </span>// exit this handler for other keys
      }
