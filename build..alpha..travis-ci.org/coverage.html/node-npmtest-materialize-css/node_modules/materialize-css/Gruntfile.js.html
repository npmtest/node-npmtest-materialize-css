...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-materialize-css/node_modules/materialize-css/Gruntfile.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-materialize-css/node_modules/materialize-css/Gruntfile.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-materialize-css/node_modules/materialize-css/</a> &#187; Gruntfile.js</div>
</div>
<div class="body">
...
610
611
612</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-contrib-compress');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-contrib-clean');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-contrib-jade');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-concurrent');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-notify');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-text-replace');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-banner');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-rename');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-remove-logging');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-browser-sync');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-contrib-jasmine');</span>
<span class="cstat-no" title="statement not covered" >  grunt.loadNpmTasks('grunt-postcss');</span>
  // define the tasks
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  grunt.registerTask('jade_compile', ['jade', 'notify:jade_compile']);</span>
<span class="cstat-no" title="statement not covered" >  grunt.registerTask('js_compile', ['concat:temp', 'uglify:bin', 'notify:js_compile', 'clean:temp']);</span>
<span class="cstat-no" title="statement not covered" >  grunt.registerTask('sass_compile', ['sass:gh', 'sass:bin', 'postcss:gh', 'postcss:bin', 'notify:sass_compile']);</span>
<span class="cstat-no" title="statement not covered" >  grunt.registerTask('server', ['browserSync', 'notify:server']);</span>
<span class="cstat-no" title="statement not covered" >  grunt.registerTask('lint', ['removelogging:source']);</span>
<span class="cstat-no" title="statement not covered" >  grunt.registerTask('monitor', ["concurrent:monitor"]);</span>
<span class="cstat-no" title="statement not covered" >  grunt.registerTask('travis', ['jasmine']);</span>
};
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
